...
interface UncontrolledTextInputListProps {
...
const UncontrolledTextInputList= (props: UncontrolledTextInputListProps) => {
    ...
    useEffect(() => {
        inputValues.current = props.forceVal || [];
        callOnChange();
...
export default UncontrolledTextInputList;