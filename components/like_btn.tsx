...
const LikeBtn= (props: LikeBtnProps) => {
    ...
    const svgClassName = props.liked? gs('svg svg_liked') : gs('svg');

    return (
        RM.modElement((
            <button className={`border-none p-1 rounded-[50%] flex items-center justify-center ${btnCname}`}
            onClick={props.onClick}>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClassName}>
